...
const About_Company = () => {
    ...
    return (
        ...
        <section id="about" className="relative py-44 bg-[#192F40] overflow-hidden h-auto bg-fixed bg-center w-auto bg-cover bg-no-repeat" style={{ backgroundImage: `url(${Img1})` }}>

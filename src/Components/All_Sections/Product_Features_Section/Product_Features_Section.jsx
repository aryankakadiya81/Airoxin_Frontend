...
const Product_Features_Section = () => {
    return (
        <motion.section
            initial={{ opacity: 0 }}
        ...
        >
            <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    {featuresData.Product_Features_Section.Title}
                ...
                >
                    {featuresData.Product_Features_Section.Data.map((feature,ind) => (
                        <motion.div
                            key={ind}
                            variants={{
...
export default Product_Features_Section;
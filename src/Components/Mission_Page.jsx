...
import Mission_OurCommitmentToExcellence_Section from './All_Sections/Mission_OurCommitmentToExcellence_Section/Mission_OurCommitmentToExcellence_Section';
import Full_Screen_Image_Section from './All_Sections/Full_Screen_Image_Section/Full_Screen_Image_Section';
import Mission_Hero_Section from './All_Sections/Mission_Hero_Section/Mission_Hero_Section';
...
const Mission_Page = () => {
    ...
    return (
        <>
            ...
            <Full_Screen_Image_Section URL={Data.Base_Image}></Full_Screen_Image_Section>
